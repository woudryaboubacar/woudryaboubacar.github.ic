...
<html>
    ...
    <meta charset="UTF-8">
        ...
        <link rel="stylesheet" href="/Loccar/Loccar_style.css" type="text/css">
        <style>
            .photocar{
    ...
    <body>
                ...
                <p><h1><b>Liste des Voitures ....</b></h1></p>
<?php 
       ...
       ?>
                   ...
                   <p><a href="acceuil.php"><img src="images/ajou.jpg" width="50px" height="50px"></a> </p>
